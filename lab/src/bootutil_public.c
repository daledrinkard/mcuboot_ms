        ...
        const uint8_t *inbuf, uint8_t inlen)
{
 ...
 //@@       return -1;
        //@@ disable this check because we can't change BOOT_MAX_ALIGN without
        //@@ Commandeering more source codes.
        //@@ The QSPI align size is 256, so there is an issue when QSPI is the primary target
    }
    erased_val = flash_area_erased_val(fap);

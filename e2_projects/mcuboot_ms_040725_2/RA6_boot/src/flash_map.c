...
static const struct flash_area flash_map[] =
{
    ...
    /** UPDATE IMAGE SLOT **/
    {
        ...
        .fa_off  = FLASH_AREA_2_OFFSET,   //@@FLASH_AREA_RESOURCES_SIZE,
        .fa_size = FLASH_AREA_2_SIZE, // + FLASH_AREA_RESOURCES_SIZE,
    },
    /** RESOURCES IMAGE SLOT **/
    {
        .fa_id = FLASH_AREA_RESOURCES_ID,
        .fa_device_id = FLASH_DEVICE_EXTERNAL_FLASH,
        .fa_off  = FLASH_AREA_RESOURCES_OFFSET,
        .fa_size = FLASH_AREA_RESOURCES_SIZE,
    },
    /** RESOURCES UPDATE IMAGE SLOT **/
    {
        .fa_id        = FLASH_AREA_RESOURCES_UPDATE_ID,
        .fa_device_id = FLASH_DEVICE_EXTERNAL_FLASH,
        .fa_off       = FLASH_AREA_RESOURCES_OFFSET + FLASH_AREA_2_SIZE,
        .fa_size      = FLASH_AREA_RESOURCES_SIZE,
    },
    ...
    //@@ add a section for the RESOURCE
    //@@ end of add
